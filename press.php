  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     if ($valid) {
        ...
        $message = "Press/Testimony User Contribution \n" .
          ...
          "Info/Testimony : \n" . 
          $_POST["comments"];
        mail('requests@violinxia.com;zheng_colin@yahoo.com',"User Press/Testimony Contribution",$message, "From: " . $email);
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="col-md-9 font-V">
          ...
          <br>
          <p>
            Spotted Xia or one of his students in the news? Have a testimony about how great Xia is? Let us know by filling out the form below.
          </p>
